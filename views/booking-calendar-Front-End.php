...
<form id="uxFrondendBookingForm" class="form-horizontal" method="post" action="" style="font-family: sans-serif;font-size: 12px;line-height: 1.4em;">
	<div class="content">
		...
		<div class="progressbar-normal green  ui-progressbar ui-widget ui-widget-content ui-corner-all" value="75%" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="75" style="width:98%;float:left;">
			<div class="ui-progressbar-value ui-widget-header ui-corner-left" id="progressBar" style="width: 25%;"></div>
		</div>
		<div id="serviceGrid"  style="display:block;float:left;width:98%;">
		...
		<div id="calendarGrid" style="display:none;float:left;width:98%;">
			<div id="calBindingMultiple" style="width: 34%;float:left;"></div>	
			<div id="timingSlot" style="float:left;width: 56%;padding:5px;margin-left:10px;border:solid 1px #ECECEC;">
				<div id="timingsGrid"></div>
			</div>
			<input type="text" id="altField" value="" style="display:none"/>
		</div>
		<div id="customerGrid" style="display:none;float:left;width:98%;">
		...
		<div style="float:left;margin-bottom:10px">
			<button type="submit" id="buttonBackStep" class="green" style="margin-top:10px;display:none;padding:0px	">
				<span>
