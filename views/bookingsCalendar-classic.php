...
<form id="uxFrondendBookingForm" class="form-horizontal" method="post" action="">
	<div class="content">
		<div class="form-wizard"></div>
			<div id="serviceGrid"  style="display:block;margin-left: 4%;">
				<?php
					...
					?>
						...
						<select id="allService" name="allService"'" onchange="servicesOnchange()" style="width:50%">
							<option value="0">
			...
			<div id="calendarGrid" style="display:block;float:left;width:98%;margin-top: 3%;">
				...
				<div id="timingSlot" style="float:left;width: 60%;display:none; padding:5px;margin-left:10px;border:solid 1px #ECECEC;">
					<div id="timingsGrid"></div>
				</div>
				<input type="text" id="altField" value="" style="display:none"/>
			</div>
			<div id="customerGrid" style="display: none;width:96%;margin-top:43%">
